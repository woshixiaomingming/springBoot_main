...
var _200=_216.children(".panel-left");
...
var url = "http://xmm.main.com/V1_0";
function login() {
    var username = $("#username").val();
    var password = $("#password").val();
    $("#login").attr("href", url + "/login?" + "username=" + username + "&password=" + password);
}